...
impl<'a> Bluehouse {
    pub fn process_ray_cpmm_swap(
        ...
        let (input_mint, output_mint, input_prog, output_prog, input_vault, output_vault) =
            if a_to_b {
                (
                    &self.base.token_a_mint,    // input_mint
                    &self.base.token_b_mint,    // output_mint
                    &self.base.token_a_program, // input_prog (token program)
                    &self.base.token_b_program, // output_prog
                    &market.vault_a,            // input_vault
                    &market.vault_b,            // output_vault
                )
            } else {
                (
                    &self.base.token_b_mint,    // input_mint
                    &self.base.token_a_mint,    // output_mint
                    &self.base.token_b_program, // input_prog (token program)
                    &self.base.token_a_program, // output_prog
