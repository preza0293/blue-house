...
impl<'a> Bluehouse {
    pub fn process_orca_swap_v2(
        ...
        let (mint_a, mint_b, token_program_a, token_program_b, ata_a, ata_b, vault_a, vault_b) =
            if a_to_b {
                (
                    &self.base.token_a_mint,    // mint_a
                    &self.base.token_b_mint,    // mint_b
                    &self.base.token_a_program, // token_program_a
                    &self.base.token_b_program, // token_program_b
                    &self.base.token_a_ata,     // ata_a
                    &self.base.token_b_ata,     // ata_b
                    &market.vault_a,            // vault_a
                    &market.vault_b,            // vault_b
                )
            } else {
                (
                    &self.base.token_b_mint,    // mint_a
                    &self.base.token_a_mint,    // mint_b
                    &self.base.token_b_program, // token_program_a
                    &self.base.token_a_program, // token_program_b
                    &self.base.token_b_ata,     // ata_a
                    &self.base.token_a_ata,     // ata_b
